...
from other_methods.sedid_like.dataset import SeDIDLikeMapDataset
from other_methods.sedid_like.classifier import SeDIDLikeResNetClassifier
...
def main():
    parser = argparse.ArgumentParser(
        description="Train a SeDID-like classifier on stepwise error maps / noise profiles."
    )

    parser.add_argument("--train_dir", type=str, required=True)
    parser.add_argument("--val_dir", type=str, required=True)
    parser.add_argument("--output_dir", type=str, default="checkpoints/sedid_like")
    ...
    train_dataset = SeDIDLikeMapDataset(
    ...
    val_dataset = SeDIDLikeMapDataset(
    ...
    model = SeDIDLikeResNetClassifier(
    ...
    print("=" * 80)
    print("Training SeDID-like classifier")
    print("=" * 80)
