...
from other_methods.anl_like.extract_maps import extract_anl_like_predicted_noise
...
def main():
    ...
    for image_path in tqdm(image_paths, desc="Extracting ANL noise"):
        ...
        try:
            ...
            predicted_noise = predicted_noise.squeeze(0).detach().cpu().half()
            ...
            torch.save(
                {
                    ...
                    "shape": tuple(predicted_noise.shape),
                },
                output_path,
            )
